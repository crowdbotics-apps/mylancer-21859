"""mylancer_21859 URL Configuration
...
admin.site.site_header = "MyLancer"
admin.site.site_title = "MyLancer Admin Portal"
admin.site.index_title = "MyLancer Admin"

# swagger
api_info = openapi.Info(
    title="MyLancer API",
    default_version="v1",
    description="API documentation for MyLancer App",
)
